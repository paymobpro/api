...
user experience мы отправляем таких пользователей _сразу_ партнеру. Партнер может по желанию запустить цикл ожидания статуса (синхронный или асинхронный) у себя. 
*/
